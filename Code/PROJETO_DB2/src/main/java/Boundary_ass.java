...
public class Boundary_ass extends javax.swing.JInternalFrame {
    ...
    public Boundary_ass(Integer cod) {
        initComponents();
    ...
    public void alterar() throws NumNegException {
        String sql = "update tbassistente set ass_nome = ?, ass_cpf = ?, ass_senha = ?, ass_tel = ?, ass_email = ? where ass_codigo = ?";
        try {
            ...
            if (ctNome.getText().isEmpty() || ctCpf.getText().isEmpty() || ctSenha.getText().isEmpty() || ctEmail.getText().isEmpty()) {
                ...
                if (add > 0) {
                    JOptionPane.showMessageDialog(null, "Dados do Assistente atualizados com sucesso", "Atualização de dados concluida", 1);
                    limpar();
                } else {
                    JOptionPane.showMessageDialog(null, "Dados do Assistente não atualizados", "ERRO de atualização", 0);
                }
    ...
    private void consultar() {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                JOptionPane.showMessageDialog(null, "Confirme os dados do Assistente", "Confirmacao de Dados", 1);
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Integer cod = 0;
                new Boundary_ass(cod).setVisible(true);
            }
        });
    }
